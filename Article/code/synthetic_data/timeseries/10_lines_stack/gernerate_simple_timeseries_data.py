...
path="/home/isabella/Documents/PLEN/dfs/insilico_datacreation/postdoc/data/noise001/timeseries/"
...
for n in range(10):
    ...
    imgnoise=gernerate_simple_timeseries_data.generate_images_from_data(df_timeseries=df_data, noiseBlur=1,noiseBack=0.005,box_size=500,
                              path='/home/isabella/Documents/PLEN/dfs/insilico_datacreation/postdoc/data/noise001/timeseries/10_lines_stack/',
